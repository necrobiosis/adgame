    ...
    const el = h(`
      <div class="screen">
        ...
        <div class="hint tips">
          ...
          <b>射程无限</b>：只要在你这一排，多远都开火。但超出有效射程之后
          伤害会衰减，<b>放近了打更疼</b>——亮带的长度就是有效射程。<br>
          <b>挡路的东西只占三排里的一排</b>，有两种：<br>
          · <b>金币墙</b>正面焊满倒刺——在撞上之前打穿它钱就归你；硬撞过去墙会碎，
          但前排会被串死一片，而且拿不到奖励。<br>
          · <b>军械门</b>上印着一把枪，打穿了这把枪就换到你手上。它不扎人，
          但你也撞不开——没打穿就被挤到旁边那一排去，什么都没有。<br>
          两种都一样：<b>不想付这个价，就换一排走。</b><br>
          大怪老远就看得见——先想好它走到跟前时你该站哪一排。<br>
          <b>空袭一局只有一发</b>（兵工厂的「空袭引导」每级多带一发）：
          落点就是你按下去那一刻的横向位置，一秒后一整条走廊会被犁平。
          什么时候用，是这一整局最重的一个决定。<br>
